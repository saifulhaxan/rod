...
export const TaskView = () => {
  ...
  useEffect(() => {
    document.title = 'Project Camp | Task View';
              ...
              <div className="dashCard">
                <div className="row mb-3 justify-content-between">
                  <div className="col-md-6 mb-2">
                    <h2 className="mainTitle">Task Management</h2>
                  </div>
                  <div className="col-md-6 mb-2">
                    <div className="addUser">
                      <CustomButton type="button" text="Add New Task" className="primaryButton" onClick={
                        (()=> {
                          setUserFrom(true)
                        })
                      } />
                            ...
                            <td>
                              <Dropdown className="tableDropdown">
                                ...
                                <Dropdown.Menu align="end" className="tableDropdownMenu">
                                  <Link to={`/task-view/task-details/${item.id}`} className="tableAction"><FontAwesomeIcon icon={faEye} className="tableActionIcon" />View</Link>
                                  <button onClick={() => {
