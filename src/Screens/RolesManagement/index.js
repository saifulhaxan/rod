...
export const RolesManagement = () => {
  ...
  useEffect(() => {
    document.title = 'Project Camp | Roles Management';
      ...
      <DashboardLayout>
        <div className="container-fluid">
                ...
                <div className="row mb-3 justify-content-between">
                  ...
                  <div className="col-md-6 mb-2">
                    <div className="addUser">
                      <CustomButton type="button" text="Add Role" className="primaryButton" onClick={() => {
                        setUser(true)
                      }} />
                            ...
                            <td>
                              <Dropdown className="tableDropdown">
                                ...
                                <Dropdown.Menu align="end" className="tableDropdownMenu">
                                  <Link to={`/roles-management/user-details/${item.id}`} className="tableAction"><FontAwesomeIcon icon={faEye} className="tableActionIcon" />View</Link>
                                  <button onClick={() => {
          ...
          <CustomModal show={addUser} close={() => { setUser(false) }} >
            ...
            />
            <CustomButton variant='primaryButton' text='Add Role' type='submit'/>
          </CustomModal>
