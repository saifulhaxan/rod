...
export const WatcherManagement = () => {
  ...
  useEffect(() => {
    document.title = 'Rod Fin | Watcher Management';
              ...
              <div className="dashCard">
                <div className="row mb-3 justify-content-between">
                  <div className="col-md-6 mb-2">
                    <h2 className="mainTitle">Watcher Management</h2>
                  </div>
                  <div className="col-md-6 mb-2">
                            ...
                            <td>
                              <Dropdown className="tableDropdown">
                                ...
                                <Dropdown.Menu align="end" className="tableDropdownMenu">
                                  <Link to={`/watcher-management/watcher-details/${item.id}`} className="tableAction"><FontAwesomeIcon icon={faEye} className="tableActionIcon" />View</Link>
                                  <button onClick={() => {
